...
namespace OTP.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public JsonResult AccountKitLoginPost(string code, string csrf_nonce, string returnUrl)
        {
        ...
        public class Token
        {
            ...
            public string token_refresh_interval_sec { get; set; }
        }
        ...
        public JsonResult TestAjax(string code, string csrf_nonce, string returnUrl)
        {
            ...
            return Json(new { message = "aaa" }, JsonRequestBehavior.AllowGet);
        }
    }
}